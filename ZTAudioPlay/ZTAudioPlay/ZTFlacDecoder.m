...
@property (retain, nonatomic) ZTFlacSource *source;
...
FLAC__StreamDecoderReadStatus ReadCallback(const FLAC__StreamDecoder *decoder,
                                           ...
                                           size_t *bytes,
                                           void *client_data) {
    ZTFlacDecoder *flacDecoder = (__bridge ZTFlacDecoder *)client_data;
