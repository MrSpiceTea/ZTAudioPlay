...
- (NSArray *)parseData:(BOOL *)isEof
{
    ...
    if (ioNumPackets > 0)
    {
        ...
        for (int i = 0; i < ioNumPackets; ++i)
        {
            ...
            ZTAudioParsedData *parsedData = [ZTAudioParsedData parsedAudioDataWithBytes:outBuffer + packetDescription.mStartOffset
...
static OSStatus AudioFileReadCallBack(void *inClientData,
                                        ...
                                        UInt32 *actualCount)
{
    ZTAudioFile *audioFile = (__bridge ZTAudioFile *)inClientData;
